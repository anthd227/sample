...
(
    BOARD_ID           integer         GENERATED BY DEFAULT AS IDENTITY NOT NULL, 
    BOARD_MASTER_ID    integer         NULL, 
...
COMMENT ON TABLE T_BOARD IS '게시글';
COMMENT ON COLUMN T_BOARD.BOARD_ID IS '게시글ID';
COMMENT ON COLUMN T_BOARD.BOARD_MASTER_ID IS '게시판마스터ID';
COMMENT ON COLUMN T_BOARD.TITLE IS '제목';
COMMENT ON COLUMN T_BOARD.CONTENT IS '내용';
COMMENT ON COLUMN T_BOARD.WRITER_ID IS '게시자ID';
COMMENT ON COLUMN T_BOARD.WRITER_NAME IS '로그인하지 않은 유저가 글 작성 시';
COMMENT ON COLUMN T_BOARD.POPUP_YN IS '팝업노출여부';
COMMENT ON COLUMN T_BOARD.GROUP_ID IS '부모글 id';
COMMENT ON COLUMN T_BOARD.GROUP_ORDER IS '원글 포함 답글 순서';
COMMENT ON COLUMN T_BOARD.DEL_YN IS '삭제여부';
COMMENT ON COLUMN T_BOARD.ADMIN_DELETE_YN IS '관리자삭제여부';
COMMENT ON COLUMN T_BOARD.DELETION_REASON IS '삭제사유';
COMMENT ON COLUMN T_BOARD.VIEWS IS '조회수';
COMMENT ON COLUMN T_BOARD.START_DATE IS '게시시작일';
COMMENT ON COLUMN T_BOARD.END_DATE IS '게시종료일';
COMMENT ON COLUMN T_BOARD.REG_ID IS '최초등록자ID';
COMMENT ON COLUMN T_BOARD.REG_DATE IS '최초등록일시';
COMMENT ON COLUMN T_BOARD.UDT_ID IS '최종수정자ID';
COMMENT ON COLUMN T_BOARD.UDT_DATE IS '최종수정일시';
...
COMMENT ON COLUMN T_BOARD_COMMENT.BOARD_ID IS '게시글ID';
COMMENT ON COLUMN T_BOARD_COMMENT.COMMENT_WRITER IS '작성자명';
...
COMMENT ON COLUMN T_BOARD_COMMENT.COMMENT_GROUP_ID IS '그룹번호';
COMMENT ON COLUMN T_BOARD_COMMENT.COMMENT_ORDER IS '댓글 순서';
...
COMMENT ON COLUMN T_BOARD_FILE.BOARD_ID IS '게시글ID';
